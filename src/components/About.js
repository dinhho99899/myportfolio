...
<div className='about-center'>
    <div className='btn-container'>
        {content.map((about,aindex)=>{
            return <button key={aindex} onClick={()=>{setIndex(aindex) }} className={ `about-btn ${index ===aindex && 'active-btn'} `}>{about.title}</button>
...
.about-center{
display:grid;
grid-template-columns: 11   0px 1fr;
...
.about-btn{ margin-bottom:0.6rem;}
}
`
